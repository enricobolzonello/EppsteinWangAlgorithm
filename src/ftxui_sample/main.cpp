...
// configuration step. It creates a namespace called `EppsteinWangAlgorithm`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", EppsteinWangAlgorithm::cmake::project_name, EppsteinWangAlgorithm::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", EppsteinWangAlgorithm::cmake::project_version);
      return EXIT_SUCCESS;
    }
